...
//   // UPDATED: Fixed PDF download and opening functionality
//   Future<void> _downloadRecipe() async {
//     try {
//       // Check if the recipe is already downloaded
//       final bool isAlreadyDownloaded =
...
//       // FIXED: Improved PDF file handling for Android
//       Directory? directory;
//       String fileName = 'recipe_${widget.mealId}.pdf';
//       File file;

//       if (Platform.isAndroid) {
//         // For Android, always use app documents directory to avoid permission issues
//         directory = await getApplicationDocumentsDirectory();
...
//           debugPrint('PDF created successfully at: ${file.path}');

//           // Save metadata for the recipe library
//           await _saveRecipeMetadata(
//               fileName, widget.mealName, widget.mealImage);
...
//                   textColor: Colors.white,
//                   onPressed: () {
//                     // Use Share.shareFiles instead of OpenFile for better compatibility
//                     Share.shareFiles(
//                       [file.path],
//                       text: 'Recipe for ${widget.mealName}',
//                     );
//                   },
//                 ),
//               ),
...
//           ScaffoldMessenger.of(context).showSnackBar(
//             SnackBar(
//               content: const Text('Recipe saved to Documents folder'),
//               backgroundColor: Colors.green,
//               duration: const Duration(seconds: 3),
//               action: SnackBarAction(
//                 label: 'Open',
